...
entry:
  ...
  br i1 %0, label %if.then.6, label %if.else.6
...
if.end.6:
  ...
  br i1 %4, label %if.then.7, label %if.else.7
...
if.end.9:
  ...
  br i1 %16, label %if.then.10, label %if.else.10
...
if.end.10:
  ...
  br i1 %20, label %if.then.11, label %if.else.11
...
if.end.11:
  ...
  br i1 %28, label %if.then.12, label %if.else.12
...
if.end.12:
  ...
  br i1 %33, label %if.then.13, label %if.else.13
...
if.end.13:
  ...
  br i1 %41, label %if.then.14, label %if.else.14
...
if.end.14:
  ...
  br i1 %46, label %if.then.15, label %if.else.15
...
if.end.15:
  ...
  br i1 %54, label %if.then.16, label %if.else.16
...
if.end.16:
  ...
  br i1 %59, label %if.then.17, label %if.else.17
...
if.end.17:
  ...
  %65 = icmp eq i32 %64, 0
  br i1 %65, label %if.then.18, label %if.else.18
...
if.end.18:
  ...
  br i1 %68, label %if.then.19, label %if.else.19
...
if.end.19:
  ...
  br i1 %73, label %if.then.20, label %if.else.20
...
if.end.20:
  ...
  br i1 %80, label %if.then.21, label %if.else.21
...
if.end.21:
  ...
  br i1 %85, label %if.then.22, label %if.else.22
...
if.end.22:
  ...
  br i1 %89, label %if.then.23, label %if.else.23
...
if.end.23:
  ...
  br i1 %98, label %if.then.24, label %if.else.24
...
if.end.24:
  ...
  br i1 %109, label %if.then.25, label %if.else.25

if.then.25:
  %110 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %110, label %if.then.26, label %if.else.26
...
if.else.25:
  ...
  br i1 %115, label %if.then.27, label %if.else.27
...
if.end.25:
  ...
  br i1 %125, label %if.then.28, label %if.else.28

if.then.28:
  %126 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %126, label %if.then.29, label %if.else.29
...
if.else.28:
  ...
  br i1 %131, label %if.then.30, label %if.else.30
...
if.end.28:
  ...
  br i1 %141, label %if.then.31, label %if.else.31

if.then.31:
  %142 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %142, label %if.then.32, label %if.else.32
...
if.else.31:
  ...
  br i1 %147, label %if.then.33, label %if.else.33
...
if.end.31:
  ...
  br i1 %156, label %if.then.34, label %if.else.34

if.then.34:
  %157 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %157, label %if.then.35, label %if.else.35
...
if.else.34:
  ...
  br i1 %162, label %if.then.36, label %if.else.36
...
if.end.34:
  ...
  br i1 %171, label %if.then.37, label %if.else.37

if.then.37:
  %172 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %172, label %if.then.38, label %if.else.38
...
if.else.37:
  ...
  br i1 %177, label %if.then.39, label %if.else.39
...
if.end.37:
  ...
  br i1 %182, label %if.then.40, label %if.else.40
...
entry:
  ...
  %0 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %0, label %if.then.41, label %if.else.41
...
if.end.41:
  ...
  %3 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %1, i8* %2)
  %4 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %4, label %if.then.42, label %if.else.42
...
if.end.42:
  ...
  %7 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %5, i8* %6)
  %8 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %8, label %if.then.43, label %if.else.43
...
if.end.43:
  ...
  %11 = call %class.IO* @_CN2IO_FN7out_int_(%class.IO* %9, i32 %10)
  %12 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %12, label %if.then.44, label %if.else.44
...
if.end.44:
  ...
  %15 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %13, i8* %14)
  %16 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %16, label %if.then.45, label %if.else.45
...
if.end.45:
  ...
  %19 = call %class.IO* @_CN2IO_FN7out_int_(%class.IO* %17, i32 %18)
  %20 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %20, label %if.then.46, label %if.else.46
...
if.end.46:
  ...
  br i1 %24, label %if.then.47, label %if.else.47
...
if.end.47:
  ...
  %28 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %28, label %if.then.48, label %if.else.48
...
if.end.48:
  ...
  br i1 %37, label %if.then.49, label %if.else.49
...
if.then.49:
  ...
  br i1 %43, label %if.then.50, label %if.else.50
...
if.else.49:
  ...
  br i1 %52, label %if.then.51, label %if.else.51
...
if.end.49:
  ...
  br i1 %58, label %if.then.52, label %if.else.52
...
if.end.52:
  ...
  br i1 %63, label %if.then.53, label %if.else.53
...
entry:
  ...
  store i32 %x, i32* %x.addr, align 4
  %0 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %0, label %if.then.54, label %if.else.54
...
if.end.54:
  ...
  %3 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %1, i8* %2)
  %4 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %4, label %if.then.55, label %if.else.55
...
if.end.55:
  ...
  %7 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %5, i8* %6)
  %8 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %8, label %if.then.56, label %if.else.56
...
if.end.56:
  ...
  %11 = call %class.IO* @_CN2IO_FN7out_int_(%class.IO* %9, i32 %10)
  %12 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %12, label %if.then.57, label %if.else.57
...
while.body:
  ...
  br i1 %23, label %if.then.58, label %if.else.58
...
if.end.58:
  ...
  %28 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %28, label %if.then.59, label %if.else.59
...
while.end:
  ...
  br i1 %37, label %if.then.60, label %if.else.60
...
if.end.60:
  ...
  br i1 %46, label %if.then.61, label %if.else.61

if.then.61:
  %47 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %47, label %if.then.62, label %if.else.62
...
if.else.61:
  ...
  br i1 %52, label %if.then.63, label %if.else.63
...
if.end.61:
  ...
  %59 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %59, label %if.then.64, label %if.else.64
...
entry:
  ...
  store i32 %x, i32* %x.addr, align 4
  %0 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %0, label %if.then.65, label %if.else.65
...
if.end.65:
  ...
  %3 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %1, i8* %2)
  %4 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %4, label %if.then.66, label %if.else.66
...
if.end.66:
  ...
  %7 = call %class.IO* @_CN2IO_FN10out_string_(%class.IO* %5, i8* %6)
  %8 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %8, label %if.then.67, label %if.else.67
...
while.body.2:
  ...
  br i1 %31, label %if.then.69, label %if.else.69
...
while.end.2:
  ...
  br i1 %39, label %if.then.70, label %if.else.70
...
while.end.1:
  %47 = icmp eq %class.SimpleExprTests* %this, null
  br i1 %47, label %if.then.71, label %if.else.71
