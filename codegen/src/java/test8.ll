...
entry:
%2 = bitcast %class.B* %this to %class.C*
call void @C$C$(%class.C* %2)
...
entry:
%4 = bitcast %class.A* %this to %class.B*
call void @B$B$(%class.B* %4)
%5 = getelementptr inbounds %class.A, %class.A* %this, i32 0, i32 1
...
entry:
%7 = bitcast %class.IO* %this to %class.Object*
...
entry:
%9 = bitcast %class.Main* %this to %class.Object*
...
entry:
%10 = bitcast i32 %this to %class.Object*
call void @Object$Object$(%class.Object* %10)
ret void 
}
...
%2 = getelementptr inbounds [3 x i8], [3 x i8]* @globalstring7, i32 0, i32 0
%3 = getelementptr inbounds [26 x i8], [26 x i8]* @globalstring17, i32 0, i32 0
%4 = call i32 (i8*, ...) @printf(i8* %2, i8* %3)
%5 = call i32 (i8*, ...) @printf(i8* %2, i8* %1)
%6 = getelementptr inbounds [2 x i8], [2 x i8]* @globalstring8, i32 0, i32 0
...
%1 = getelementptr inbounds [3 x i8], [3 x i8]* @globalstring5, i32 0, i32 0
...
entry:
%0 = alloca i8*, align 8
%1 = getelementptr inbounds [10 x i8], [10 x i8]*@globalstring4, i32 0, i32 0
...
entry:
%11 = getelementptr inbounds [42 X i8], [42 X i8]* @globalstring15 , i32 0 , i32 0
%12 = getelementptr inbounds [3 X i8], [3 X i8]* @globalstring7 , i32 0 , i32 0
%r = call i32 (i8*, ...) @printf(i8* %12, i8* %11)
ret void
}

define void @reportErrorVoid(){
entry:
%13 = getelementptr inbounds [45 X i8], [45 X i8]* @globalstring16 , i32 0 , i32 0
%14 = getelementptr inbounds [3 X i8], [3 X i8]* @globalstring7 , i32 0 , i32 0
%r = call i32 (i8*, ...) @printf(i8* %14, i8* %13)
ret void
}


@globalstring9 = private unnamed_addr constant [1 x i8] c"\00", align 1
@globalstring16 = private unnamed_addr constant [45 x i8] c"
...
@globalstring14 = private unnamed_addr constant [3 x i8] c"IO\00", align 1
@globalstring17 = private unnamed_addr constant [26 x i8] c"
Abort called from class \00", align 1
@globalstring8 = private unnamed_addr constant [2 x i8] c"
\00", align 1
@globalstring6 = private unnamed_addr constant [4 x i8] c"%d
\00", align 1
@globalstring12 = private unnamed_addr constant [7 x i8] c"String\00", align 1
@globalstring7 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@globalstring10 = private unnamed_addr constant [4 x i8] c"Int\00", align 1
@globalstring11 = private unnamed_addr constant [5 x i8] c"Bool\00", align 1
@globalstring15 = private unnamed_addr constant [42 x i8] c"
Error : Division by 0 is not permissible\00", align 1
@globalstring13 = private unnamed_addr constant [7 x i8] c"Object\00", align 1
@globalstring3 = private unnamed_addr constant [5 x i8] c"Main\00", align 1
@globalstring4 = private unnamed_addr constant [10 x i8] c"%1024[^
]\00", align 1
@globalstring5 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
