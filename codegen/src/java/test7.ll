...
define i32 @A$f$(%class.A* %this, i32 %x, i32 %y){
...
entry:
%%x.a_ = alloca i32 , align 8
store i32 %x , i32* %x.a_ , align 4
%%y.a_ = alloca i32 , align 8
store i32 %y , i32* %y.a_ , align 4
ret i32 0
}

define i32 @B$f$(%class.B* %this, i32 %x, i32 %y){
